...
X_train = pca.fit_transform(preprocessing.scale(LBC36_smoke.iloc[:,2:n-1].to_numpy()))
y_train = LBC36_smoke.iloc[:,-1].to_numpy()

X_test = pca.transform(preprocessing.scale(LBC21_smoke.iloc[:,2:n-1].to_numpy()))
...
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+OLS.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+Ridge.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+Lasso.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+ElasticNet.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+SVM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+RF.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+GBM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/PCA+MLP.csv', index = False, header=True)

lw = 1
plt.figure(figsize=[10,10], dpi=300)
plt.title('ROC curve')
plt.plot(linr_fpr, linr_tpr, color = 'black', lw = lw, label = 'PCA + OLS (AUC = %0.3f)' % linr_roc_auc)
plt.plot(ridge_fpr, ridge_tpr, color = 'b', lw = lw, label = 'PCA + Ridge (AUC = %0.3f)' % ridge_roc_auc)
plt.plot(lasso_fpr, lasso_tpr, color = 'g', lw = lw, label = 'PCA + Lasso (AUC = %0.3f)' % lasso_roc_auc)
plt.plot(elnet_fpr, elnet_tpr, color = 'r', lw = lw, label = 'PCA + ElasticNet (AUC = %0.3f)' % elnet_roc_auc)
plt.plot(svc_fpr, svc_tpr, color = 'c', lw = lw, label = 'PCA + SVM (AUC = %0.3f)' % svc_roc_auc)
plt.plot(rf_fpr, rf_tpr, color = 'm', lw = lw, label = 'PCA + RF (AUC = %0.3f)' % rf_roc_auc)
plt.plot(gbm_fpr, gbm_tpr, color = 'y', lw = lw, label = 'PCA + GBM (AUC = %0.3f)' % gbm_roc_auc)
plt.plot(mlp_fpr, mlp_tpr, color = 'darkorange', lw = lw, label = 'PCA + MLP (AUC = %0.3f)' % mlp_roc_auc)
...
plt.savefig("/home/uqxqian/90days/Prediction/ML_linear/smoke_final/plot/PCA_ROC.png")
