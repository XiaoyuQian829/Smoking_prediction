...
linear_score = pd.read_table("/home/uqxqian/90days/Prediction/ML_linear/smoke_osca/smoke_LBC36_linear.score", sep="\s+", header=0)
linear_probes = linear_score.iloc[:,0].values.tolist()
...
X_train = preprocessing.scale(LBC36_smoke[linear_probes].to_numpy())
y_train = LBC36_smoke.iloc[:,-1].to_numpy()

X_test = preprocessing.scale(LBC21_smoke[linear_probes].to_numpy())
...
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+OLS.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+Ridge.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+Lasso.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+ElasticNet.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+SVM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+RF.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+GBM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/Linear+MLP.csv', index = False, header=True)
...
plt.savefig("/home/uqxqian/90days/Prediction/ML_linear/smoke_final/plot/Linear_ROC.png")
