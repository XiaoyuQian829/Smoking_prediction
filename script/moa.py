...
moa_score = pd.read_table("/home/uqxqian/90days/Prediction/ML_linear/smoke_osca/smoke_LBC36_moa.score", sep="\s+", header=0)
moa_probes = moa_score.iloc[:,0].values.tolist()
...
X_train = preprocessing.scale(LBC36_smoke[moa_probes].to_numpy())
y_train = LBC36_smoke.iloc[:,-1].to_numpy()

X_test = preprocessing.scale(LBC21_smoke[moa_probes].to_numpy())
...
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+OLS.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+Ridge.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+Lasso.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+ElasticNet.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+SVM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+RF.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+GBM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOA+MLP.csv', index = False, header=True)
...
plt.savefig("/home/uqxqian/90days/Prediction/ML_linear/smoke_final/plot/MOA_ROC.png")
