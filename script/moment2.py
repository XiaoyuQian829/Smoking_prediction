...
moment2_score = pd.read_table("/home/uqxqian/90days/Prediction/ML_linear/smoke_osca/smoke_LBC36_moment2.score", sep="\s+", header=0)
moment2_probes = moment2_score.iloc[:,0].values.tolist()
...
X_train = preprocessing.scale(LBC36_smoke[moment2_probes].to_numpy())
y_train = LBC36_smoke.iloc[:,-1].to_numpy()

X_test = preprocessing.scale(LBC21_smoke[moment2_probes].to_numpy())
...
d = {'IID' : LBC21_individuals, 'Smoking': LBC21_smoke.iloc[:,-1]}
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/LBC21_smoking.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+OLS.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+Ridge.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+Lasso.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+ElasticNet.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+SVM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+RF.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+GBM.csv', index = False, header=True)
...
df = pd.DataFrame(data=d)
df.to_csv('/home/uqxqian/90days/Prediction/ML_linear/smoke_final/prediction/MOMENT2+MLP.csv', index = False, header=True)
...
plt.savefig("/home/uqxqian/90days/Prediction/ML_linear/smoke_final/plot/MOMENT2_ROC.png")
